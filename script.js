...
function finalizarPedido() {
    ...
    const texto = `Olá! Gostaria de fazer o seguinte pedido:%0A${mensagem}%0A` +
        `Total: R$ ${formatarValor(total + taxaDeEntrega)}%0A` +
        `Taxa de entrega: R$ ${formatarValor(taxaDeEntrega)}%0A` +
        `Bairro: ${bairro}%0A` +
